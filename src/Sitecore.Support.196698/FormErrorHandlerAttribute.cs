namespace Sitecore.Support.Forms.Mvc.Attributes
{
  ...
  public class FormErrorHandlerAttribute : HandleErrorAttribute
  {
    ...
    public override void OnException(ExceptionContext filterContext)
    {
      ...
      {        
        Log.Error("Failed to handle form error. Request is redirected to not found", ex, this);
        Log.Error("Original form exception.", filterContext.Exception, this);
        filterContext.HttpContext.Response.Redirect(Configuration.Settings.ItemNotFoundUrl);
      }
    }
  }
}
